...
// Canonical video protocol endpoints live under /api/video-protocol/protocols,
// /api/video-protocol/video-records and /api/video-protocol/video-stages.
// This root route delegates to the same implementation so a request to
// /api/video-protocol never returns silent empty/501 placeholders.
